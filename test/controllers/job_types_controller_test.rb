...
class JobTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create job_type" do
    assert_difference('JobType.count') do
      post job_types_url, params: { job_type: { active: @job_type.active, details: @job_type.details, title: @job_type.title, user_id: @job_type.user_id } }
    end
  ...
  test "should update job_type" do
    patch job_type_url(@job_type), params: { job_type: { active: @job_type.active, details: @job_type.details, title: @job_type.title, user_id: @job_type.user_id } }
